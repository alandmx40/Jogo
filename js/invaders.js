...
function preload() {
    ...
    game.load.image('enemyBullet', 'img/bullet277.png');
    game.load.spritesheet('invader', 'img/invader32x32x4.png', 32, 32);
    game.load.image('ship', 'img/player1.png');
    game.load.image('ship', 'img/player2.png');
    game.load.spritesheet('kaboom', 'img/explode.png', 128, 128);
    game.load.image('starfield', 'img/map-japan.png');
...
function create() {
    ...
    //  The hero!
    player2 = game.add.sprite(300, 500, 'ship');
    ...
    leftButton = game.input.keyboard.addKey (Phaser.Keyboard.S);
    rightButton = game.input.keyboard.addKey (Phaser.Keyboard.D);
    fireButton2 = game.input.keyboard.addKey (Phaser.Keyboard.W);
...
function createAliens () {
    ...
    for (var y = 0; y < 4; y++)
    {
        for (var x = 0; x < 10; x++)
        {
            ...
            alien.animations.add('fly', [ 0, 1, 2, 3], 100, false);
            alien.play('fly');
